                            ...
                            <div class="order-summary-content">
                                ...
                                <div class="order-payment-method">
                                    <div class="single-payment-method show">
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="cashon"  value="1" class="custom-control-input" name='phuong_thuc_thanh_toan_id' checked="">
                                                <label class="custom-control-label" for="cashon">Thanh toán khi nhận hàng</label>
                                            </div>
                                        </div>
                                        <div class="payment-method-details" data-method="cash" style="display: none;">
                                    ...
                                    <div class="single-payment-method">
                                        <div class="payment-method-name">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="directbank"  value="2" class="custom-control-input" name='phuong_thuc_thanh_toan_id'>
                                                <label class="custom-control-label" for="directbank">Thanh toán qua banking (ONLINE)</label>
                                            </div>
                                        </div>
